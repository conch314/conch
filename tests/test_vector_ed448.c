...
struct test_vector test_ed448_vector_1 = {
	{
	...
	}, EDDSA_ED448_PUB_LEN,
	{
		...
		0x26, 0x00
	}, EDDSA_ED448_SIGN_LEN
	};

struct test_vector test_ed448_vector_2 = {
	{
...
struct test_vector test_ed448_vector_3 = {
	{
...
struct test_vector test_ed448_vector_4 = {
	{
...
struct test_vector test_ed448_vector_5 = {
	{
...
struct test_vector test_ed448_vector_6 = {
	{
...
struct test_vector test_ed448_vector_7 = {
	{
...
struct test_vector test_ed448_vector_8 = {
	{
...
void _test_ed448(struct test_vector *t, int32_t n)
{
	printf("case %d vector:\n", n);
	print_vector(t);

	conch_eddsa_ed448_public_key(t->in_pri, g_buf);

	printf("out_pub: %u -- %s\n ", t->out_pub_len,
		verify_cmp(g_buf, t->out_pub, t->out_pub_len));
	print_hex(g_buf, t->out_pub_len);

	conch_eddsa_ed448_sign(t->in_pri,
	...
	int32_t r = conch_eddsa_ed448_verify(g_buf, g_buf2,
		t->in_msg, t->in_msg_len);
...
void test_ed448(void)
{
	printf("==== ED448 ====\n\n");

	_test_ed448(&test_ed448_vector_1, 1);
	_test_ed448(&test_ed448_vector_2, 2);
	_test_ed448(&test_ed448_vector_3, 3);
	_test_ed448(&test_ed448_vector_4, 4);
	_test_ed448(&test_ed448_vector_5, 5);
	_test_ed448(&test_ed448_vector_6, 6);
	_test_ed448(&test_ed448_vector_7, 7);
	_test_ed448(&test_ed448_vector_8, 8);
}
