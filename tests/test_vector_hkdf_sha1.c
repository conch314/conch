...
void _test_hkdf_sha1(struct test_vector *t, int32_t n)
{
...
void test_hkdf_sha1(void)
{
	printf("==== HKDF SHA1 ====\n\n");

	_test_hkdf_sha1(&test_sha1_vector_1, 1);
	_test_hkdf_sha1(&test_sha1_vector_2, 2);
	_test_hkdf_sha1(&test_sha1_vector_3, 3);
}
