...
void _test_x25519(struct test_vector *t, int32_t n)
{
	...
	conch_ecdh_x25519_public_key(t->in_a_pri, g_a_pub);
	conch_ecdh_x25519_public_key(t->in_b_pri, g_b_pub);
	...
	conch_ecdh_x25519_shared_key(t->in_a_pri, g_b_pub, g_buf);

	printf("out_a_key: %u -- %s\n ", t->out_key_len,
		verify_cmp(g_buf, t->out_key, t->out_key_len));
	print_hex(g_buf, t->out_key_len);

	conch_ecdh_x25519_shared_key(t->in_b_pri, g_a_pub, g_buf);
...
void _test_x25519_u(struct test_vector_u *t, int32_t n)
{
	...
	conch_ecdh_x25519_shared_key(t->in_s, t->in_u, g_buf);
