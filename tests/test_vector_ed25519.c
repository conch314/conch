...
struct test_vector test_ed25519_vector_1 = {
	{
	...
	}, EDDSA_ED25519_SIGN_LEN
	};

struct test_vector test_ed25519_vector_2 = {
	{
...
struct test_vector test_ed25519_vector_3 = {
	{
...
struct test_vector test_ed25519_vector_4 = {
	{
...
struct test_vector test_ed25519_vector_5 = {
	{
...
void _test_ed25519(struct test_vector *t, int32_t n)
{
	printf("case %d vector:\n", n);
	print_vector(t);

	conch_eddsa_ed25519_public_key(t->in_pri, g_buf);

	printf("out_pub: %u -- %s\n ", t->out_pub_len,
		verify_cmp(g_buf, t->out_pub, t->out_pub_len));
	print_hex(g_buf, t->out_pub_len);

	conch_eddsa_ed25519_sign(t->in_pri,
	...
	int32_t r = conch_eddsa_ed25519_verify(g_buf, g_buf2,
		t->in_msg, t->in_msg_len);
...
void test_ed25519(void)
{
	...
	_test_ed25519(&test_ed25519_vector_1, 1);
	_test_ed25519(&test_ed25519_vector_2, 2);
	_test_ed25519(&test_ed25519_vector_3, 3);
	_test_ed25519(&test_ed25519_vector_4, 4);
	_test_ed25519(&test_ed25519_vector_5, 5);
}
