...
void test_curve25519(void)
{
	...
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdh_x25519_public_key((uint8_t *)pri, pub);
	}
	end = clock();
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdh_x25519_shared_key((uint8_t *)pri, pub, key);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_eddsa_ed25519_public_key((uint8_t *)pri, pub);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("pub time: %.6f (%.2f/s)\n", time / 500, 500 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_eddsa_ed25519_sign((uint8_t *)pri,
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_eddsa_ed25519_verify((uint8_t *)pub, sign,
...
void test_curve448(void)
{
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdh_x448_public_key((uint8_t *)pri, pub);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("pub time: %.6f (%.2f/s)\n", time / 500, 500 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdh_x448_shared_key((uint8_t *)pri, pub, key);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("key time: %.6f (%.2f/s)\n", time / 500, 500 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_eddsa_ed448_public_key((uint8_t *)pri, pub);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("pub time: %.6f (%.2f/s)\n", time / 500, 500 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_eddsa_ed448_sign((uint8_t *)pri,
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_eddsa_ed448_verify((uint8_t *)pub, sign,
...
void test_p256(void)
{
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdh_p256_public_key((uint8_t *)pri, pub);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("pub time: %.6f (%.2f/s)\n", time / 500, 500 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdh_p256_shared_key((uint8_t *)pri, pub, key);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("key time: %.6f (%.2f/s)\n", time / 500, 500 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdsa_p256_public_key((uint8_t *)pri, pub);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("pub time: %.6f (%.2f/s)\n", time / 500, 500 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdsa_p256_sign((uint8_t *)pri, (uint8_t *)ran,
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdsa_p256_verify((uint8_t *)pub, sign,
...
void test_p384(void)
{
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdh_p384_public_key((uint8_t *)pri, pub);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("pub time: %.6f (%.2f/s)\n", time / 500, 500 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdh_p384_shared_key((uint8_t *)pri, pub, key);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("key time: %.6f (%.2f/s)\n", time / 500, 500 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdsa_p384_public_key((uint8_t *)pri, pub);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("pub time: %.6f (%.2f/s)\n", time / 500, 500 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdsa_p384_sign((uint8_t *)pri, (uint8_t *)ran,
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdsa_p384_verify((uint8_t *)pub, sign,
...
void test_p521(void)
{
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdh_p521_public_key((uint8_t *)pri, pub);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("pub time: %.6f (%.2f/s)\n", time / 500, 500 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdh_p521_shared_key((uint8_t *)pri, pub, key);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("key time: %.6f (%.2f/s)\n", time / 500, 500 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdsa_p521_public_key((uint8_t *)pri, pub);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("pub time: %.6f (%.2f/s)\n", time / 500, 500 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdsa_p521_sign((uint8_t *)pri, (uint8_t *)ran,
	...
	start = clock();
	for (int32_t i = 0; i < 500; i++) {
		conch_ecdsa_p521_verify((uint8_t *)pub, sign,
