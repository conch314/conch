...
void test_mlkem512(void)
{
	...
	for (int32_t i = 0; i < 1000; i++) {
		conch_mlkem512_genkey(ran, msg, ek, dk);
	}
	end = clock();
	...
	start = clock();
	for (int32_t i = 0; i < 1000; i++) {
		conch_mlkem512_encaps(msg, ek, ct, sk);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	...
	start = clock();
	for (int32_t i = 0; i < 1000; i++) {
		conch_mlkem512_decaps(dk, ct, sk);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
...
void test_mlkem768(void)
{
	...
	start = clock();
	for (int32_t i = 0; i < 1000; i++) {
		conch_mlkem768_genkey(ran, msg, ek, dk);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("genkey time: %.6f (%.2f/s)\n", time / 1000, 1000 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 1000; i++) {
		conch_mlkem768_encaps(msg, ek, ct, sk);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("encaps time: %.6f (%.2f/s)\n", time / 1000, 1000 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 1000; i++) {
		conch_mlkem768_decaps(dk, ct, sk);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("decaps time: %.6f (%.2f/s)\n", time / 1000, 1000 / time);
...
void test_mlkem1024(void)
{
	...
	start = clock();
	for (int32_t i = 0; i < 1000; i++) {
		conch_mlkem1024_genkey(ran, msg, ek, dk);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("genkey time: %.6f (%.2f/s)\n", time / 1000, 1000 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 1000; i++) {
		conch_mlkem1024_encaps(msg, ek, ct, sk);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("encaps time: %.6f (%.2f/s)\n", time / 1000, 1000 / time);
	...
	start = clock();
	for (int32_t i = 0; i < 1000; i++) {
		conch_mlkem1024_decaps(dk, ct, sk);
	}
	end = clock();
	time = (double)(end - start) / CLOCKS_PER_SEC;
	printf("decaps time: %.6f (%.2f/s)\n", time / 1000, 1000 / time);
