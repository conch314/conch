...
/* aes xtime */
static const uint8_t aes_xtime_table[256] = {
...
/* aes invmul 0x09 */
static const uint8_t aes_invmul_0_table[256] = {
...
/* aes invmul 0x0b */
static const uint8_t aes_invmul_1_table[256] = {
...
/* aes invmul 0x0d */
static const uint8_t aes_invmul_2_table[256] = {
...
/* aes invmul 0x0e */
static const uint8_t aes_invmul_3_table[256] = {
...
{
	uint8_t a, b, *col;
	for (int32_t i = 0; i < AES_BLOCKSIZE; i += 4) {
		col = &state[i];
		a = col[0];
...
/* @func: _aes_invmixcolumns (static)
 * #desc:
...
static void _aes_invmixcolumns(uint8_t *state)
{
	...
	for (int32_t i = 0; i < AES_BLOCKSIZE; i += 4) {
		...
		uint8_t e = _aes_invmultiply(a, 0x0e);
...
void conch_aes_decrypt(struct aes_ctx *ctx, uint8_t *state)
{
	...
	for (int32_t i = ctx->rounds - 1; i > 0; i--) {
