 ...
 */
void conch_ecdh_x25519_public_key(const uint8_t *pri, uint8_t *pub)
{
	uint32_t _pri[8], _pub[8];

	conch_memcpy(_pri, pri, ECDH_X25519_PRI_LEN);
	...
	conch_memcpy(pub, _pub, ECDH_X25519_PUB_LEN);
}

/* @func: conch_ecdh_x25519_shared_key
 * #desc:
 ...
 */
int32_t conch_ecdh_x25519_shared_key(const uint8_t *pri,
		const uint8_t *pub, uint8_t *key)
{
	uint32_t _pri[8], _pub[8], _key[8];

	conch_memcpy(_pri, pri, ECDH_X25519_PRI_LEN);
	conch_memcpy(_pub, pub, ECDH_X25519_PUB_LEN);
	...
	conch_memcpy(key, _key, ECDH_X25519_KEY_LEN);

	return 0 - _fp25519_iszero(_key);
}

/* @func: conch_eddsa_ed25519_nonce_key
 * #desc:
 ...
 * #3: ran   [out] nonce
 */
void conch_eddsa_ed25519_nonce_key(const uint8_t *inpri, uint8_t *pri,
		uint8_t *ran)
{
	uint32_t _pri[8];
	SHA512_NEW(sha_ctx);
	...
	conch_sha512(&sha_ctx, inpri, EDDSA_ED25519_PRI_LEN);
	...
	conch_memcpy(pri, _pri, EDDSA_ED25519_PRI_LEN);
}

/* @func: conch_eddsa_ed25519_public_key
 * #desc:
 ...
 * #2: pub [out] public key
 */
void conch_eddsa_ed25519_public_key(const uint8_t *pri, uint8_t *pub)
{
	...
	conch_memcpy(pub, _pub, EDDSA_ED25519_PUB_LEN);
}

/* @func: conch_eddsa_ed25519_sign
 * #desc:
...
/* @func: conch_eddsa_ed25519_verify
 * #desc:
