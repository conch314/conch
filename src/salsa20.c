 ...
 * #4: ctr [in]  counter
 */
void conch_salsa20_init(struct salsa20_ctx *ctx, const uint8_t *key,
 ...
 * #2: n   [in]     rounds
 */
void conch_salsa20_block(struct salsa20_ctx *ctx, int32_t n)
{
