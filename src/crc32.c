/* @file: crc32.c
 * #desc:
 *    The implementations of cyclic redundancy check (32-bit).
 *
 * #copy:
...
/* crc32/iso not reversed: 0x04c11db7 (msb) */
static const uint32_t crc32_table_m[256] = {
...
/* crc32/iso after reversed: 0xedb88320 (lsb) */
static const uint32_t crc32_table_l[256] = {
...
/* crc32/castagnoli not reversed: 0x1edc6f41 (msb) */
static const uint32_t crc32_table_mc[256] = {
...
/* crc32/castagnoli after reversed: 0x82f63b78 (lsb) */
static const uint32_t crc32_table_lc[256] = {
...
/* crc32/koopman not reversed: 0x741b8cd7 (msb) */
static const uint32_t crc32_table_mk[256] = {
...
/* crc32/koopman after reversed: 0xeb31d82e (lsb) */
static const uint32_t crc32_table_lk[256] = {
...
/* crc32/q not reversed: 0x814141ab (msb) */
static const uint32_t crc32_table_mq[256] = {
...
/* crc32/q after reversed: 0xd5828281 (lsb) */
static const uint32_t crc32_table_lq[256] = {
...
/* @func: conch_crc32_cksum_size_msb
 * #desc:
...
uint32_t conch_crc32(const uint8_t *s, uint32_t len, int32_t type)
{
	...
	switch (type) {
		case CRC32_DEFAULT_MSB_TYPE:
			c = conch_crc32_msb(crc32_table_m, b, s, len);
			return c ^ e;
		case CRC32_DEFAULT_LSB_TYPE:
			c = conch_crc32_lsb(crc32_table_l, b, s, len);
			return c ^ e;
		case CRC32_CASTAGNOLI_MSB_TYPE:
			c = conch_crc32_msb(crc32_table_mc, b, s, len);
			return c ^ e;
		case CRC32_CASTAGNOLI_LSB_TYPE:
			c = conch_crc32_lsb(crc32_table_lc, b, s, len);
			return c ^ e;
		case CRC32_KOOPMAN_MSB_TYPE:
			c = conch_crc32_msb(crc32_table_mk, b, s, len);
			return c ^ e;
		case CRC32_KOOPMAN_LSB_TYPE:
			c = conch_crc32_lsb(crc32_table_lk, b, s, len);
			return c ^ e;
		case CRC32_Q_MSB_TYPE:
			c = conch_crc32_msb(crc32_table_mq, 0, s, len);
			return c;
		case CRC32_Q_LSB_TYPE:
			c = conch_crc32_lsb(crc32_table_lq, 0, s, len);
			return c;
		case CRC32_CKSUM_MSB_TYPE:
			c = conch_crc32_msb(crc32_table_m, 0, s, len);
			return conch_crc32_cksum_size_msb(crc32_table_m,
				c, len);
		default:
			return 0;
	}
