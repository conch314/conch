 ...
 */
void conch_base32_enc(const char *s, uint32_t slen, char *t,
		uint32_t *tlen)
{
	uint32_t n = *tlen;
	while (slen) {
 ...
 */
int32_t conch_base32_dec(const char *s, uint32_t slen, char *t,
		uint32_t *tlen)
{
	char buf[8];
	int32_t k = 0;
