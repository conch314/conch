...
/* 768 */
#define MLKEM_512_POLYVEC_BYTES (MLKEM_POLY_BYTES * MLKEM_512_K)
/* 640 */
#define MLKEM_512_POLYVEC_COMPRESS \
	(MLKEM_512_POLY_COMPRESS_DU * MLKEM_512_K)

/* 800 */
#define MLKEM_512_EKPKE_LEN (MLKEM_512_POLYVEC_BYTES + MLKEM_SYM_LEN)
/* 768 */
...
/* 1152 */
#define MLKEM_768_POLYVEC_BYTES (MLKEM_POLY_BYTES * MLKEM_768_K)
/* 960 */
#define MLKEM_768_POLYVEC_COMPRESS \
	(MLKEM_768_POLY_COMPRESS_DU * MLKEM_768_K)

/* 1184 */
#define MLKEM_768_EKPKE_LEN (MLKEM_768_POLYVEC_BYTES + MLKEM_SYM_LEN)
/* 1152 */
...
/* 1536 */
#define MLKEM_1024_POLYVEC_BYTES (MLKEM_POLY_BYTES * MLKEM_1024_K)
/* 1408 */
#define MLKEM_1024_POLYVEC_COMPRESS \
	(MLKEM_1024_POLY_COMPRESS_DU * MLKEM_1024_K)

/* 1568 */
#define MLKEM_1024_EKPKE_LEN (MLKEM_1024_POLYVEC_BYTES + MLKEM_SYM_LEN)
/* 1536 */
