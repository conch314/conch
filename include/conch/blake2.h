...
#ifndef _CONCH_BLAKE2_H
#define _CONCH_BLAKE2_H
...
/* blake2b.c */
extern
int32_t conch_blake2b_init(struct blake2b_ctx *ctx, uint32_t dsize)
;
extern
void conch_blake2b_init_param(struct blake2b_ctx *ctx,
		const struct blake2b_param *p)
;
extern
void conch_blake2b_process(struct blake2b_ctx *ctx, const uint8_t *s,
		size_t len)
;
extern
...
/* blake2s.c */
extern
int32_t conch_blake2s_init(struct blake2s_ctx *ctx, uint32_t dsize)
;
extern
void conch_blake2s_init_param(struct blake2s_ctx *ctx,
		const struct blake2s_param *p)
;
extern
void conch_blake2s_process(struct blake2s_ctx *ctx, const uint8_t *s,
		size_t len)
;
extern
